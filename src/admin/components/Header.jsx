      ...
      <nav className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className='flex space-x-4'>
            <h2 className='text-white bg-blue-500 text-md px-3 py-1 rounded-full font-extrabold cursor-pointer' onClick={handleDetail}>{username.slice(0, 1).toUpperCase()}</h2>
            <Link
              to="/Admin"
